											...
											<tbody>
												...
												?>
													<tr>
														...
														<td>
															<a class=" label label-warning" href="proyectos/editar.php?id=<?php echo $row->idcaso; ?>"> Editar</a>
															<?php if (($row->correo == $_SESSION['correo'])) {
																echo '<a  title="Enviar a votacion a votacion "class="label label-info" href="proyectos/votaciones.php?id=' . $row->idcaso . '"> Finalizar  </a>';
															}
															?>
															<a title="Eliminar " class="label label-danger" href="proyectos/borrar.php?id=<?php echo $row->idcaso; ?>">Eliminar </a>
