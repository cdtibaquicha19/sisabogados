...
<input type="hidden" name="correos" value="<?php while($row = mysqli_fetch_object($result)){ echo $row->correo.",";}?>"/>
			<br>
			<?php while($row2 = mysqli_fetch_object($result2)){ echo $row2->nombre."<br>";}?>
