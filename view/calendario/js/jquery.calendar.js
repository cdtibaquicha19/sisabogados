	...
	({
		...
		{	
            ...
            var defaults = 
			{
				...
				newEventText: 'Agregar nuevo evento',
				successAddEventMessage: 'Evento agregado exitosamente',
				successDeleteEventMessage: 'Evento eliminado con éxito',
				successUpdateEventMessage: 'Evento actualizado con éxito',
				failureAddEventMessage: 'No se pudo agregar el evento',
				failureDeleteEventMessage: 'Error al eliminar el evento',
				failureUpdateEventMessage: 'Error al actualizar el evento',
				generalFailureMessage: 'Error al ejecutar la acción',
				ajaxError: 'No se pudo cargar el contenido.',
				emptyForm: 'El formulario no puede estar vacío',
				
				eventText: 'Evento: ',
				repetitiveEventActionText: 'Este es un evento repetitivo, ¿qué quieres hacer?',
