						...
						<div class="col-md-12">
							<div class="block-web">
								<div class="header">
									...
									<h3 class="content-header">Listado de asignaciones creadas </h3>
								</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td>
															<?php echo $row->feha_fin; ?>
														</td>
														<td>
															<?php if ($row->id_empleado == $_SESSION['correo']) {
																echo '<a  title="Enviar a votacion a votacion "class="btn btn-info" href="editar.php?id=' . $row->id_proyecto . '"><i class="fa fa-check fa-lg" aria-hidden="true"></i></a>';
															}
															?>
