...
<head>
	...
	<title>DASHBOARD / ABOGADOS </title>
			...
			<div class="left_nav">
				...
				<div class="left_nav_slidebar">
					<ul>
						...
						<li class="left_nav_active theme_border"> <a href=""> <i class="fa fa-tasks"></i>ASIGNACIONES
			...
			<div class="contentpanel">
				...
				<div class="pull-left breadcrumb_admin clear_both">
					<div class="pull-left page_title theme_color">
						<h1 style="color : #182d4c">Tus asignaciones
							</a></h1>
									...
									<div class="table-responsive">
										<table class="display table table-bordered table-striped" id="dynamic-table">
											...
											<tbody>
												...
												$sql = "select * from asignaciones where id_empleado ='".$_SESSION['correo']."' ORDER BY `asignaciones`.`id` DESC ";
												$result = db_query($sql);
												while ($row = mysqli_fetch_object($result)) {
												?>
													<tr>
														...
														<td>
															<a class=" label label-warning" href="proyectos/editar.php?id=<?php echo $row->id_proyecto; ?>"> Editar</a>
															<a title="Eliminar " class="label label-danger" href="proyectos/borrar.php?id=<?php echo $row->id_proyecto; ?>">Eliminar </a>
